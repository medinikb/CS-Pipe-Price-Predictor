...
function renderMaterialCategoryTables(items) {
  ...
  elements.categoryTables.innerHTML = groups
...
function buildCsvRows() {
  ...
  rows.push(["Category", "Line Count", "Total Weight kg", "Normal Total Rs", "P90 Total Rs"]);
...
function printReport() {
  updateReportGenerated();
  document
    .querySelectorAll(".category-review-details, .category-audit-details")
    .forEach((details) => {
      details.open = true;
    });
  window.print();
