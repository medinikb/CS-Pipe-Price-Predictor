...
CS Pipe Price Predictor is a free public carbon steel pipe price calculator for material supply cost estimation. It helps users estimate pipe supply price from size, thickness, length, coating condition, raw steel rate, kg/m pipe weight, normal estimate, and P90 budget estimate.
...
- Supports coated CS pipe price estimate and non-coated pipe estimate.
...
- Groups pipe rows by material category for review, such as Carbon Steel Pipe, Alloy Steel Pipe, Stainless Steel Pipe, and Unclassified Pipe.
...
The app includes a collapsed **Material Category Review** section. It helps users see how uploaded pipe rows are grouped for review.
